...
// sets the output to result. The result type might be a single field for:
// a single return value, a slice of values for single-value return types,
// or a struct for multiple return values.
...
//
// Solidity: function balanceOf(address _owner) view returns(balance uint256)
